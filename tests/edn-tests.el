...
(ert-deftest invalid-edn ()
  (should-error (edn-parse "///"))
  (should-error (edn-parse "~cat"))
  (should-error (edn-parse "foo/bar/baz/qux/quux"))
  (should-error (edn-parse "#foo/"))
  (should-error (edn-parse "foo/"))
  (should-error (edn-parse ":foo/"))
  (should-error (edn-parse "#/foo"))
  (should-error (edn-parse "/symbol"))
  (should-error (edn-parse ":/foo"))
  (should-error (edn-parse "+5symbol"))
  (should-error (edn-parse ".\\newline"))
  (should-error (edn-parse "0cat"))
  (should-error (edn-parse "-4cats"))
  (should-error (edn-parse ".9"))
  (should-error (edn-parse ":keyword/with/too/many/slashes"))
  (should-error (edn-parse ":a.b.c/"))
  (should-error (edn-parse "\\itstoolong"))
  (should-error (edn-parse ":#/:"))
  (should-error (edn-parse "/foo//"))
  (should-error (edn-parse "///foo"))
  (should-error (edn-parse ":{}"))
  ...
  (should-error (edn-parse "##"))
  (should-error (edn-parse "::"))
  (should-error (edn-parse "::a"))
  (should-error (edn-parse ".5symbol"))
  (should-error (edn-parse "{ \"foo\""))
  (should-error (edn-parse "{ \"foo\" :bar"))
  (should-error (edn-parse "{"))
  (should-error (edn-parse ":{"))
  (should-error (edn-parse "{{"))
  (should-error (edn-parse "}"))
